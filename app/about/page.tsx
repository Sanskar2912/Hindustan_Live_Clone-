    ...
    return (
        <div className="container mx-auto px-4 py-12 max-w-3xl">
            ...
            <div className="prose prose-lg text-gray-700">
                <p>
                    Welcome to <strong>Hindustan Live</strong>, your premier destination for reliable, up-to-the-minute news coverage.
                </p>
                <p>
                ...
                <p>
                    Whether you are looking for breaking news, in-depth analysis, or just the latest cricket scores, हिंदुस्तान लाइव has you covered.
                </p>
            </div>
        </div>
    );
